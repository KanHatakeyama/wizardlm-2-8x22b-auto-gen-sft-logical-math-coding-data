...
detailed, and step-by-step answers to the user's questions. USER: {question} ASSISTANT:"""
    return prompt


def question_to_prompt_2nd_turn(q1, a1, q2, role="an artificial intelligence assistant"):
    prompt = f"""A chat between a curious user and {role}. The assistant gives helpful, 
detailed, and step-by-step answers to the user's questions. USER: {q1} ASSISTANT: {a1} USER: {q2} ASSISTANT:"""
    return prompt
